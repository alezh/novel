...
func (b *Bootstrapper) SetupViews(viewsDir string,reload bool) {
	b.RegisterView(iris.HTML(viewsDir, ".html").Layout("shared/layout.html").Reload(reload))
}
func (b *Bootstrapper) SetupViewsNotLayout(viewsDir string) {
...
func (b *Bootstrapper) Bootstrap() *Bootstrapper {
	b.SetupViews("../github.com/alezh/novel/views",false)
